...
var LuckyFile = /** @class */ (function (_super) {
    ...
    */
    ...
    LuckyFile.prototype.getComments=function(){
        let comments=[]
        for (let i = 0; i < this.sheets.length; i++) {
          let cm=this.readXml.getFileByName(`xl/comments${i+1}.xml`);
          if(!cm.length)continue
          comments.push({sheetIndex: this.sheets[i].index,xml:cm})
        }
    ...
    */
    ...
    LuckyFile.prototype.toJsonString = function (file) {
        ...
        LuckyOutPutFile.comments = file.comments;
